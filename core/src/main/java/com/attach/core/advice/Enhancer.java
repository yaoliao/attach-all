...
import com.attach.core.util.reflect.FieldUtils;
...
//    private static final Logger logger = LogUtil.getArthasLogger();
    ...
    private void spy(final ClassLoader targetClassLoader) throws Exception {
        ...
        Class<?> spyClass = targetClassLoader.loadClass("com.attach.agent.Spy");
...
//        }
    ...
    private static boolean isSelf(Class<?> clazz) {
        return null != clazz
                && Objects.equals(clazz.getClassLoader(), Enhancer.class.getClassLoader());
    }
